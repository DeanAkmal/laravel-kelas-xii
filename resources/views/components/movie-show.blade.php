  ...
  <div class="agileits-single-top">
    ...
    <div class="single-page-agile-info">
      ...
      <div class="col-md-4 single-right">
        <h3>Similar Films By Genre</h3>
        @foreach ($filmByGenre as $genreFilm)
        <div class="single-grid-right">
          <div class="single-right-grids">
            <div class="col-md-4 single-right-grid-left">
              <a href="{{ route('movies.show', $genreFilm->id) }}"><img src="/{{ $genreFilm->poster }}" alt="" /></a>
            </div>
            <div class="col-md-8 single-right-grid-right">
              <a href="{{ route('movies.show', $genreFilm->id) }}" class="title">{{ $genreFilm->title }}</a>
              <p class="author"><a href="#" class="author">{{ $genreFilm->year }}</a></p>
              <p class="views" style="text-align: justify; margin-right: 10px">{{ $genreFilm->sinopsis }}</p>
            </div>
            <div class="clearfix">
